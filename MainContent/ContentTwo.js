...
export default function ContentTwo(){
  return(
    <div >
      ...
      <h3 style={{textAlign: 'center'}}>High Impact offline events</h3>
      <p style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>Members are also invited to Specialized, High Impact, One-Day, Career Advancement & Strategic Transformation (CAST) Workshops held Offline at select Cities & Countries, for an Immersive Learning & Networking experience enabling them :-</p>
      <p> a)  Broaden & Deepen their Leadership Foundations while learning first hand with us.</p>
      <p>b) Efficiently Network & Build Relationships with their finest peers.</p>
      
  <p>These High Impact, One Day, Offline CAST events are aligned to the Strategic Career Management & Leadership Development needs at Three stages of our Members' Life :-</p>
  ...
  <main class="grid">
    ...
    <article>
      ...
      <div class="text">
        <h3>Category VII - Emerging Leaders</h3>
